...
!    PI%npars=29 ! dont forget to change in cardamom_io.f90
    ...
    if (DATAin%PFT == 1) then
       ...
       ! TOR SOM
       PI%parmin(9)=0.000001 ! 0.0000001
       PI%parmax(9)=0.001 ! 0.0001?

       ! Temp factor* = Q10 = 1.2-2.0
       PI%parmin(10)=0.018
       PI%parmax(10)=0.07
...
!    PI%npars=34;
    ...
    ! mineralisation rate of litter (day-1)
    PI%parmin(9)=1e-5*24.0 ; PI%parmax(9)=1e-2*24.0
    ! mineralisation rate of SOM (day-1)
