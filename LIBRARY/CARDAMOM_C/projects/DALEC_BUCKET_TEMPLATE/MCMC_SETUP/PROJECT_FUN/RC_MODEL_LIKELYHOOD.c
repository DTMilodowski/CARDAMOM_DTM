...
RC=RC1_BUCKET(PARS,&RCD, DATA->meantemp,DATA->meanrad);
...
/*RC2 check*/
RC=RC*RC2_BUCKET(PARS, DATA->MET, DATA->M_LAI, DATA->M_NEE, DATA->M_POOLS,DATA->M_FLUXES,DATA->nodays,PI,&RCD,DATA->meantemp);
