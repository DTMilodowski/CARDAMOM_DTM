...
#include <stdlib.h>
#include <string.h>
#include "../../DALEC_CODE/DALEC_FIRES/PARS_INFO_FIRES.c"
#include "../../CARDAMOM_GENERAL/CARDAMOM_READ_BINARY_DATA.c"
#include "PROJECT_FUN/FIND_RC_INITIAL_VALUES.c"
...
DATA->M_FLUXES=calloc(DATA->nodays*nofluxes,sizeof(double));
...
FIND_RC_INITIAL_VALUES(*DATA,PI);
