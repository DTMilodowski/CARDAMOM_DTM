...
#include "PARS_INFO_BUCKET.c"

#include "../RC/RC1_BUCKET.c"
#include "../RC/RC2_BUCKET.c"
...
meanrad+=MET[n*6+3]/(double)nr;}
 ...
 RCD.DIAG=1;
 RC[0]=RC1_BUCKET(pars,&RCD,meantemp,meanrad);
 RC[0]=RC[0]*(double)RC2_BUCKET(pars,MET,LAI,NEE,POOLS, FLUXES,nr,parinfo,&RCD,meantemp);
