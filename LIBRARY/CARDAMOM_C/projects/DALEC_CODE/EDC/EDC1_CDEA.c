...
int EDC1_CDEA(double const *pars, struct EDCDIAGNOSTIC *EDCD, double meantemp, double meanrad)
{
...
/*EDC no 5 is addressed in EDC2_CDEA.c*/
...
/*EDC CHECK NO 5*/
if ((EDC==1 || DIAG==1) & ((ffol+flab)>5*froot | (ffol+flab)*5<froot)){EDC=0;EDCD->PASSFAIL[5-1]=0;}
