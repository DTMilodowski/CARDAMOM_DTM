...
#include "mex.h"
#include "math.h"
#include "DALEC_CDEA_POWERTEST.c"
#include "PARS_INFO_CDEA.c"

#include "../RC/RC1_CDEA.c"
#include "../RC/RC2_CDEA.c"
...
meanrad+=MET[n*6+3]/(double)nr;}
 ...
 RCD.DIAG=1;
 RC[0]=RC1_CDEA(pars,&RCD,meantemp,meanrad);
 RC[0]=RC[0]*(double)RC2_CDEA(pars,MET,LAI,NEE,POOLS, FLUXES,nr,parinfo,&RCD,meantemp);
